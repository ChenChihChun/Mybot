        ...
        executor.execute(() -> {
            ...
            try {
                ...
                body.put("prompt", "你是一位專業的台股分析師。今天是 " + today + "。\n\n"
                        ...
                        + stockInfo + "\n\n"
                        + "【重要規則】\n"
                        + "- 你沒有網路搜尋功能，請不要嘗試使用任何工具\n"
                        + "- 絕對不要捏造或編造任何新聞事件、營收數字或具體日期\n"
                        + "- 你不知道的事情就直接說「無法確認最新動態」，不要虛構\n"
                        + "- 請在分析開頭標注：「⚠️ 以下分析基於 AI 訓練資料，可能不含最新消息」\n\n"
                        + "請根據以上即時技術數據，提供投資分析（約300-500字）：\n"
                        + "1. 技術面分析（重點）：根據提供的均線、布林通道、RSI 指標解讀多空訊號、支撐壓力位\n"
                        + "2. 產業背景：根據你的知識說明該公司所屬產業的一般趨勢\n"
                        + "3. 國際局勢參考：根據你的知識提供可能影響該股的國際因素（如有不確定請明確標註）\n"
                        + "4. 短中期展望與操作建議（偏多/偏空/觀望），給出建議的支撐與壓力價位\n\n"
                        + "直接回覆純文字分析，不要使用任何工具，不要回傳 JSON。"
                        + "注意：這僅供參考，不構成投資建議。");
