...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Row 5: 00981A ETF 動向, 00993A ETF 動向, 模擬交易
        ...
        addCompact(fRow5, "\uD83D\uDCCA", "00993A 動向", UIHelper.ACCENT_PURPLE,
                v -> {
                    Intent intent = new Intent(this, ETFTrackingActivity.class);
                    intent.putExtra(ETFTrackingActivity.EXTRA_ETF_CODE, "00993A");
